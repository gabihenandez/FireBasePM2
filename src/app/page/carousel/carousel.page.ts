...
export class CarouselPage implements OnInit {
  ...
  constructor(private datos:DatosService,private barcodeScanner: BarcodeScanner,private fireService : FireServiceService,private router:Router) { 
    this.datos.getUrl().subscribe(res =>{
      this.img = res;
      console.log(res);
    })
   }
  ...
  openScanner(){
    ...
    this.barcodeScanner.scan(options).then(barcodeData => {
      ...
      this.fireService.disparadorData.emit(this.dataQr)
